<?php
    ...
    $res1 = $req->fetch();
    $_SESSION['id_salle'] = $_POST['id_salle'];
?>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0">Modifier un tarif</h2>
                        <hr class="divider"/>
                        <p class="text-muted mb-5">Modifier un tarif dans la base de donnée</p>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        <form action="add_tarif_DB.php" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="prix" type="text" value="<?php echo $res1['prix_unitaire'] ?>" placeholder="Prix unitaire" data-sb-validations="required" name="prix" />
                            ...
                            <div class="d-grid"><button class="btn btn-primary btn-xl " id="submitButton" type="submit">Modifier le tarif</button></div>
                        </form>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center">
