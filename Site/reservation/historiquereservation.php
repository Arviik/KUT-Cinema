                    ...
                    <?php
                        ...
                        foreach ($res as $reservation){
                            echo "<tr style='text-align: center'>
                                    ...
                                    <td><form action='delete_reservation.php' method='post'><input alt='Bouton supprimer' type='image' src='../assets/img/delete_logo.png' height='20'><input hidden type='text' name='id_reservation' value='".$reservation['id_reservation']."'></form></td>
                                </tr>
                                 ";
                        }
                    ?>
