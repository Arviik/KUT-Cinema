...
VALUES ('Default film','2000','1h 30m','Default','No one','No one','Default film aim to provide something to fill different pages with a recognizable and temporary thing to put.','../assets/img/affiche/default_film.png','../assets/img/image_bg/bg-default_film.jpg'),
